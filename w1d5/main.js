(function() {
    ...
    console.log("Expected output of reverse('Philip') is pilihP " + myFunctionTest('pilihP', reverse('Philip')));

    console.log("Expected output of findLongestWords(['lorem','ipsum','sarfos']) is sarfos " + myFunctionTest('sarfos', findLongestWords(['lorem', 'ipsum', 'sarfos'])));


    console.log("Expected output of filterLongWords(['lorem','ipsum','sarfophil'],6) is ['sarfophil'] " + assertArray(['sarfophil'], filterLongWords(['lorem', 'ipsum', 'sarfophil'], 6)));
    ...
    describe("intro to js unit ", function() {
        ...
        it("findLongestWords(['lorem','ipsum','sarfos']) is sarfos", function() {
            assert.equal(findLongestWords(['lorem', 'ipsum', 'sarfos']), 'sarfos')
        })

        it("filterLongWords(['lorem','ipsum','sarfophil'],6) is ['sarfophil']", function() {
            assert.equal(filterLongWords(['lorem', 'ipsum', 'sarfophil'], 6).toString(), ['sarfophil'].toString())
        })
